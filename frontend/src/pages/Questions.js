...
const Questions = () => {
  ...
  const handleNextPage = () => {
    if ((currentPage - 1) * questionsPerPage + questionsPerPage < questions.length) {
      setCurrentPage(currentPage + 1);
    }
  };
      ...
      <div className="flex justify-center mb-2">
        <button
          ...
          className={`flex items-center justify-center px-4 h-10 mr-3 text-base font-medium ${
            currentPage === 1 ? 'text-gray-300 pointer-events-none' : 'text-gray-500'
        ...
        <button
          ...
          className={`flex items-center justify-center px-4 h-10 text-base font-medium ${
            (currentPage - 1) * questionsPerPage + questionsPerPage >= questions.length
          ...
          disabled={(currentPage - 1) * questionsPerPage + questionsPerPage >= questions.length}
        >
          Next
        </button>
      </div>
